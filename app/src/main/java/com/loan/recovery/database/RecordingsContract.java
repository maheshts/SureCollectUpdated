...
class RecordingsContract {
   ...
   public static class Recordings implements BaseColumns {
       ...
       public static final String COLUMN_NAME_CALL_META_DATA = "metadata";
       public static final String COLUMN_NAME_CALL_RECORDING_FILE = "recording";
       public static final String COLUMN_NAME_FROM_PHONE = "fromphone";

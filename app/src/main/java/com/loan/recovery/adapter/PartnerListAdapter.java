...
public class PartnerListAdapter extends ArrayAdapter<Partner> {
    ...
    public PartnerListAdapter(@NonNull Context context, int resource, List<Partner> data) {

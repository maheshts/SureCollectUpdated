...
public class RealestateProjectListAdapter extends ArrayAdapter<ProjectData> {
    private List<ProjectData> mData;
    private LayoutInflater mInflater;
    private int layout;
    private ItemClickListener mClickListener;

    public RealestateProjectListAdapter(@NonNull Context context, int resource, List<ProjectData> data) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ProjectData partner = mData.get(position);
    ...
    public interface ItemClickListener {
        void onItemClick(ProjectData partner);
    }
}
